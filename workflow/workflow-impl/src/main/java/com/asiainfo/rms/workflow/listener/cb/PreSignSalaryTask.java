...
@Component("createSalaryProcessSignTaskListener")
public class PreSignSalaryTask extends CreateSignTaskListener {
	...
	public void updateObjCurPhaseAndCurStatus(String objId, String objType, String linkId) throws Exception {
		...
		String hql = "UPDATE ALM_CB_Salary SET CUR_STATUS=?, CUR_PHASE=? WHERE s_ID=?";
		log.info("UPDATE ALM_CB_Salary SET CUR_STATUS="+linkId+", CUR_PHASE="+workflowBO.getPhaseId()+" WHERE s_ID="+objId);
