 ...
 */
@Entity
@Table(name = "ALM_CB_FINE_FLOW")
public class BOAlmCbFineFlow {
	...
	@Id
	@GeneratedValue(strategy= GenerationType.SEQUENCE,generator="ALM_CB_FINE_FLOW_SEQ")
	@SequenceGenerator(sequenceName="ALM_CB_FINE_FLOW$SEQ",allocationSize=1,name="ALM_CB_FINE_FLOW_SEQ")
	@Column(name = "FINE_ID", unique = true, nullable = false, insertable = true, updatable = true, length = 22)
	...
	@Column(name = "IS_VALID", unique = false, nullable = true, insertable = true, updatable = true, length = 2)
	...
	@Column(name = "UNVALID_REASON", unique = false, nullable = true, insertable = true, updatable = true, length = 4000)
	...
	@Column(name = "FINE_TYPE", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	...
	@Column(name = "FINE_MONEY", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	...
	@Column(name = "FINE_DESC", unique = false, nullable = true, insertable = true, updatable = true, length = 4000)
	...
	@Column(name = "REDUCE_ADD", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	...
	@Column(name = "FINE_AMOUNT", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	...
	@Column(name = "FINE_FORMULA", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	...
	@Column(name = "FINE_ACCOUNT", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	...
	@Column(name = "FLOW_ID", unique = false, nullable = true, insertable = true, updatable = true, length = 22)
