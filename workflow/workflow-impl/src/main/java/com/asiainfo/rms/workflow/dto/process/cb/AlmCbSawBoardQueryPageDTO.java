...
public class AlmCbSawBoardQueryPageDTO {
	
	@ApiModelProperty(value = "主键(开始)")
	private Long sb_id_begin;
	
	@ApiModelProperty(value = "主键(结束)")
	private Long sb_id_end;
	
	@ApiModelProperty(value = "编码")
	private java.lang.String sb_tag;
	...
	public Long getSb_id_begin() {
		return this.sb_id_begin;
	}
	
	public void setSb_id_begin(Long value) {
		this.sb_id_begin = value;
	}
	
	public Long getSb_id_end() {
		return this.sb_id_end;
	}
	
	public void setSb_id_end(Long value) {
		this.sb_id_end = value;
	}
	public java.lang.String getSb_tag() {
		return this.sb_tag;
	}

	public void setSb_tag(java.lang.String value) {
		this.sb_tag = value;
	}	    	
