 ...
 * @author joker
 */
public class AlmCbFlowHisQueryPageBO {
	
	/**
	 * 历史流水主键(开始)
	 */
	private Long hisFlowIdBegin;
	
	/**
	 * 历史流水主键(结束)
	 */
	private Long hisFlowIdEnd;
	 ...
	 * 申请人主键(开始)
	 */
	private Long appalyStaffIdBegin;
	
	/**
	 * 申请人主键(结束)
	 */
	private Long appalyStaffIdEnd;
	...
	public Long getHisFlowIdBegin() {
		return this.hisFlowIdBegin;
	}
	
	public void setHisFlowIdBegin(Long value) {
		this.hisFlowIdBegin = value;
	}
	
	public Long getHisFlowIdEnd() {
		return this.hisFlowIdEnd;
	}
	
	public void setHisFlowIdEnd(Long value) {
		this.hisFlowIdEnd = value;
	}
	...
	public Long getAppalyStaffIdBegin() {
		return this.appalyStaffIdBegin;
	}
	
	public void setAppalyStaffIdBegin(Long value) {
		this.appalyStaffIdBegin = value;
	}
	
	public Long getAppalyStaffIdEnd() {
		return this.appalyStaffIdEnd;
	}
	
	public void setAppalyStaffIdEnd(Long value) {
		this.appalyStaffIdEnd = value;
	}
