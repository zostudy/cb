...
public class AlmCbRepairBoardQueryPageDTO {
	
	@ApiModelProperty(value = "主键(开始)")
	private Long rb_id_begin;
	
	@ApiModelProperty(value = "主键(结束)")
	private Long rb_id_end;
	
	@ApiModelProperty(value = "编码")
	private java.lang.String rb_tag;
	...
	public Long getRb_id_begin() {
		return this.rb_id_begin;
	}
	
	public void setRb_id_begin(Long value) {
		this.rb_id_begin = value;
	}
	
	public Long getRb_id_end() {
		return this.rb_id_end;
	}
	
	public void setRb_id_end(Long value) {
		this.rb_id_end = value;
	}
	public java.lang.String getRb_tag() {
		return this.rb_tag;
	}

	public void setRb_tag(java.lang.String value) {
		this.rb_tag = value;
	}	    	
