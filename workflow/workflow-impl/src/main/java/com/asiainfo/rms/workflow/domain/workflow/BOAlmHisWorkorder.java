 ...
 *
 */
@Entity @Table(name="ALM_HIS_WORKORDER")
public class BOAlmHisWorkorder {

	@Id@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="hisWorkorderSeq")
	@SequenceGenerator(initialValue = 1, name = "hisWorkorderSeq", sequenceName = "ALM_HIS_WORKORDER$SEQ",allocationSize=1)
	@Column(name="HIS_ORDER_ID",length=12)
	private Long hisOrderId;
	
	@Column(name="ORDER_ID",length=12,nullable=false)
	...
	public void setHisOrderId(Long hisOrderId) {
