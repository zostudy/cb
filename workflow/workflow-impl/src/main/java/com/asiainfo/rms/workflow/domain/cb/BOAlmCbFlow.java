 ...
 */
@Entity
@Table(name = "ALM_CB_FLOW")
public class BOAlmCbFlow {
	...
	@Id
	@GeneratedValue(strategy= GenerationType.SEQUENCE,generator="ALM_CB_FLOW_SEQ")
	@SequenceGenerator(sequenceName="ALM_CB_FLOW$SEQ",allocationSize=1,name="ALM_CB_FLOW_SEQ")
	@Column(name = "FLOW_ID", unique = true, nullable = false, insertable = true, updatable = true, length = 22)
