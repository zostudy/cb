...
@Component("createRepairBoardProcessSignTaskListener")
public class PreSignRepairBoardTask extends CreateSignTaskListener {
	...
	public void updateObjCurPhaseAndCurStatus(String objId, String objType, String linkId) throws Exception {
		...
		String hql = "UPDATE ALM_CB_Repair_Board SET CUR_STATUS=?, CUR_PHASE=? WHERE rb_ID=?";
		log.info("UPDATE ALM_CB_Repair_Board SET CUR_STATUS="+linkId+", CUR_PHASE="+workflowBO.getPhaseId()+" WHERE rb_ID="+objId);
