...
@Component("createThermoCompressorProcessSignTaskListener")
public class PreSignThermoCompressorTask extends CreateSignTaskListener {
	...
	public void updateObjCurPhaseAndCurStatus(String objId, String objType, String linkId) throws Exception {
		...
		String hql = "UPDATE ALM_CB_THERMO_COMPRESSOR SET CUR_STATUS=?, CUR_PHASE=? WHERE TC_ID=?";
		log.info("UPDATE ALM_CB_THERMO_COMPRESSOR SET CUR_STATUS="+linkId+", CUR_PHASE="+workflowBO.getPhaseId()+" WHERE TC_ID="+objId);
