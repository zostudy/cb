...
public class AlmCbFineFlowQueryPageDTO {
	
	@ApiModelProperty(value = "流水主键(开始)")
	private Long fine_id_begin;
	
	@ApiModelProperty(value = "流水主键(结束)")
	private Long fine_id_end;
	...
	@ApiModelProperty(value = "是否可用(开始)")
	private Integer is_valid_begin;
	
	@ApiModelProperty(value = "是否可用(结束)")
	private Integer is_valid_end;
	
	@ApiModelProperty(value = "不可用原因")
	private java.lang.String unvalid_reason;
	...
	private java.lang.String fine_type;
	
	@ApiModelProperty(value = "罚款金额")
	private java.lang.String fine_money;
	
	@ApiModelProperty(value = "罚款描述")
	private java.lang.String fine_desc;
	
	@ApiModelProperty(value = "加减标识")
	private java.lang.String reduce_add;
	
	@ApiModelProperty(value = "罚金数量")
	private java.lang.String fine_amount;
	
	@ApiModelProperty(value = "罚金公式")
	private java.lang.String fine_formula;
	
	@ApiModelProperty(value = "罚金总额")
	private java.lang.String fine_account;
	...
	public Long getFine_id_begin() {
		return this.fine_id_begin;
	}
	
	public void setFine_id_begin(Long value) {
		this.fine_id_begin = value;
	}
	
	public Long getFine_id_end() {
		return this.fine_id_end;
	}
	
	public void setFine_id_end(Long value) {
		this.fine_id_end = value;
	}
	...
	public Integer getIs_valid_begin() {
		return this.is_valid_begin;
	}
	
	public void setIs_valid_begin(Integer value) {
		this.is_valid_begin = value;
	}
	
	public Integer getIs_valid_end() {
		return this.is_valid_end;
	}
	
	public void setIs_valid_end(Integer value) {
		this.is_valid_end = value;
	}
	public java.lang.String getUnvalid_reason() {
		return this.unvalid_reason;
	}

	public void setUnvalid_reason(java.lang.String value) {
		this.unvalid_reason = value;
	}	    	
	...
	public java.lang.String getFine_type() {
		return this.fine_type;
	}

	public void setFine_type(java.lang.String value) {
		this.fine_type = value;
	}	    	
	public java.lang.String getFine_money() {
		return this.fine_money;
	}

	public void setFine_money(java.lang.String value) {
		this.fine_money = value;
	}	    	
	public java.lang.String getFine_desc() {
		return this.fine_desc;
	}

	public void setFine_desc(java.lang.String value) {
		this.fine_desc = value;
	}	    	
	public java.lang.String getReduce_add() {
		return this.reduce_add;
	}

	public void setReduce_add(java.lang.String value) {
		this.reduce_add = value;
	}	    	
	public java.lang.String getFine_amount() {
		return this.fine_amount;
	}

	public void setFine_amount(java.lang.String value) {
		this.fine_amount = value;
	}	    	
	public java.lang.String getFine_formula() {
		return this.fine_formula;
	}

	public void setFine_formula(java.lang.String value) {
		this.fine_formula = value;
	}	    	
	public java.lang.String getFine_account() {
		return this.fine_account;
	}

	public void setFine_account(java.lang.String value) {
		this.fine_account = value;
	}	    	
